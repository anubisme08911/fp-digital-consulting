            ...
            <div style="text-align: center; max-width: 600px; margin: 0 auto;">
                ...
                <div class="contact-form-container">
                    <form id="contactForm" class="contact-form" method="post" action="includes/send-email.php">
                        ...
                        <div id="formSuccess" class="form-success-message"<?php if (!empty($formSuccess)): ?> style="display: block;"<?php endif; ?>>
                            <?php echo $formSuccess; ?>
                        </div>
                        
                        <div id="formError" class="form-error-message"<?php if (!empty($formError)): ?> style="display: block;"<?php endif; ?>>
                            <?php echo $formError; ?>
                        </div>
